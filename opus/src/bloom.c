...
static int bloom_check_add(struct bloom * bloom,
                           const char * buffer, int len, int add)
{
  if (bloom->ready == 0) {
...
int bloom_check(struct bloom * bloom, const char * buffer, int len)
{
  return bloom_check_add(bloom, buffer, len, 0);
}


int bloom_add(struct bloom * bloom, const char * buffer, int len)
{
