...
// Generate symmetric matrix in A of size 'cxc' and starting at specified row,column
static void generate_sym_matrix(double* A, size_t start_row, size_t start_col, size_t c, size_t n_A) {
...
static void generate_P_matrix(double* A, size_t c, size_t d, size_t start_row_1, size_t start_col_1, size_t start_row_2, size_t start_col_2, size_t n_A) {
...
// Generate P matrix in A of size 'cxd' and starting at specified row,column
static void dump_zeros(double* A, size_t start_row, size_t start_col, size_t d, size_t n_A) {
...
static void tile_matrices(double* A_ge, double* A_lu, double* A_tri, double* b, size_t c, size_t d) {
    size_t n_A = c + d;
...
static void pre_perf_test(double* A_ge, double* A_lu, double* A_tri, double* b, double* x, size_t n, size_t d) {
...
static void run_perf_tests_single(double* A_ge, double* A_lu, double* A_tri, double* b, double* x, size_t n, size_t d) {
...
*/
void run_perf_tests_range(size_t start, size_t step, size_t stop, range_scheme_t scheme) {
    double* A_ge = NULL;
    double* A_lu = NULL;
    double* A_tri = NULL;
    double* b = NULL; 
